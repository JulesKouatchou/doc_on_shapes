...
module polygon_mod
   ...
   type, extends(shape) :: polygon
      !! Derived type to define a polygon using
...
!>
! Initialize an arbitrary polygon by passing the
! two arrays of coordinatesand and a name.
